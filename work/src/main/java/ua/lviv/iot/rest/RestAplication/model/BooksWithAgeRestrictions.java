...
public class BooksWithAgeRestrictions extends Bookstore {
...
/*
	public String getHeaders() {
		return super.getHeaders() + "," + "ageRestrictions" + "," + "foulLanguage";
	}

	public String toCSV() {
		return super.toCSV() + "," + getAgeRestrictons() + "," + getFoulLanguage() + "\n";
	}
*/
}
