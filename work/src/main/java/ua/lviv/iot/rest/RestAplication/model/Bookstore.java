...
public class Bookstore {
	...
	public String toString() {
		return "Bookstore{" + "  name=" + name + ", producer=" + producer + ", genreType=" + genreType
				+ ", numberOfPages=" + numberOfPages + ", textLanguage=" + textLanguage + ", newCondition="
				+ newCondition + ", hardCover=" + hardCover + ", priceInUAH=" + priceInUAH + '}';
	}
	...
	/*
	 * public String getHeaders() { return "name" + "," + " producer" + "," +
	 * "genreType" + "," + "numberOfPages" + "," + "textLanguage" + "," +
	 * "newCondition " + "," + " hardCover" + "," + "priceInUAH"; }
	 * 
	 * public String toCSV() { return getName() + "," + getProducer() + "," +
	 * getGenreType() + "," + getNumberOfPages() + "," + getTextLanguage() + "," +
	 * isNewCondition() + "," + isNardCover() + "," + getPriceInUAH(); }
	 */
}
