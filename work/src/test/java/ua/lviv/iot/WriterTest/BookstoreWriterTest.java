...
public class BookstoreWriterTest extends GeneralBookstoreManagerTest {
	 ...
	 * 
	 * @Test void writeToFileTest() throws IOException { Writer csvWriter = new
	 * FileWriter("BookstoreWriter.csv"); bookstoreWriter.setCsvWriter(csvWriter);
	 ...
	 * (Bookstore listOfGoods : goods) { expected.append(listOfGoods.toCSV());
	 * expected.append("\n"); } assertEquals(expected.toString(),
	 * bookstoreWriter.toString());
	 * 
	 * }
	 */
}